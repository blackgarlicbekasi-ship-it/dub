        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[600px] rounded border border-solid border-neutral-200 px-10 py-5">
            ...
            <Text className="mb-6 text-sm leading-6 text-neutral-600">
              {isStablecoin
                ? "Great news! Your stablecoin wallet has been successfully connected to your Ingat partner account. You're all set to receive USDC payouts."
                : "Great news! Your bank account has been successfully connected to your Ingat partner account. You're all set to receive payouts."}
            </Text>
