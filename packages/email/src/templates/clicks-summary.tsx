...
export default function ClicksSummary({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your 30-day Ingat summary for {workspaceName}</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[600px] rounded border border-solid border-neutral-200 px-10 py-5">
            ...
            <Heading className="mx-0 my-7 p-0 text-lg font-medium text-black">
              Your 30-day Ingat summary for {workspaceName}
            </Heading>
            <Text className="text-sm leading-6 text-black">
              In the last 30 days, your Ingat workspace,{" "}
                      ...
                      return (
                        <div key={linkId}>
                          <Row>
                            <Column align="left">
                              <Link
                                href={`https://app.ingat.cc/${workspaceSlug}/analytics?linkId=${linkId}`}
              ...
              <>
                ...
                <Section className="my-8">
                  <Link
                    ...
                    href={`https://app.ingat.cc/${workspaceSlug}/analytics?interval=30d`}
                  >
                    View my stats
                  </Link>
                </Section>
