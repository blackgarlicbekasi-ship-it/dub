  ...
  return (
    <Html>
      ...
      <Preview>
        ...
        create your Ingat Partner account to complete your application.
      </Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[600px] rounded border border-solid border-neutral-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-neutral-600">
              ...
              saved, but you still need to create your Ingat Partners account
            ...
            <Section className="mt-8 text-center">
              <Link
                href={`https://app.ingat.cc/${program.slug}/register`}
              ...
              >
                Create your Ingat Partners account
              </Link>
            </Section>
