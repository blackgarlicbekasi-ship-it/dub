    ...
    <>
            ...
            {user.workspace && (
              <MenuButton
                ...
                onClick={() => {
                  setOpen(false);
                  window.open(
                    `https://app.ingat.cc/${user.workspace!.slug}`,
                    "_blank",
                  );
                }}
              />
      ...
      {modal === "password" && (
        <ChangePasswordModal
          ...
          onSubmit={(password) => {
            setModal(null);
            handleAction("change_password", { password });
          }}
        />
      )}
    ...
    >
      <div className="w-full max-w-sm rounded-xl bg-white p-6 shadow-xl">
        ...
        <p className="mb-2 text-sm text-neutral-500">
          ...
          their workspaces, links, and data.
        </p>
