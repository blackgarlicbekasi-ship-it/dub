          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              disabledTooltip={
                showAdvancedUpsell ? (
                  <TooltipContent
                    title="[Advanced reward structures](https://ingat.cc/help/article/partner-rewards#adding-reward-conditions) are only available on the Advanced plan and above."
