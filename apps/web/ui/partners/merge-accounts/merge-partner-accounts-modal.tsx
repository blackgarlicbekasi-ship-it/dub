  ...
  return (
    <div>
      <div className="flex items-center gap-2 border-b border-neutral-200 p-4 sm:p-6">
        ...
        <InfoTooltip content="Learn how to merge one of your partner accounts with another, to keep things organized and better managed. [Learn more](https://ingat.cc/help/article/merging-partner-accounts)" />
      </div>
