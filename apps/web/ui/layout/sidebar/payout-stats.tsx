          ...
          <div className="grid gap-1 text-xs">
            ...
            <div className="flex items-center gap-1">
              {partner && !partner.payoutsEnabledAt && (
                <Tooltip
                  content="You need to connect your payout account to be able to receive payouts from the programs you are enrolled in. [Learn more](https://ingat.cc/help/article/receiving-payouts)"
                  side="right"
                >
                  <div>
