            ...
            <div className="grid gap-px p-2">
              ...
              {options.includes("transfer") && (
                <Button
                  ...
                  disabledTooltip={
                    !isDubDomain(link.domain)
                      ? "Since this is a custom domain link, you can only transfer it to another workspace if you transfer the domain as well. [Learn more.](https://ingat.cc/help/article/how-to-transfer-domains)"
                      : !canManageLink
